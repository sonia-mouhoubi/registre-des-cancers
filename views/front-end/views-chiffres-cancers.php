<?php 
$title = 'Page des chiffres des cancers de Haute-Viennes - Registre des cancers de Limoge'; 
...
<main>
    <section class="cancer-figures">
        ...
        <div>
            <h2>L’estimation du nombre total de décès par cancer s’élève en 2018, à 157 000 dont 57 % chez l’homme.</h2> 

            <p>Lorem ipsum dolor sit amet. Vel harum ipsum non nostrum nesciunt ut consequatur eligendi ea illo minus et magni itaque aut dolorem mollitia. Eos perspiciatis accusantium ut molestias ullam ut corrupti voluptatibus.Lorem ipsum dolor sit amet. Vel harum ipsum non nostrum nesciunt ut consequatur eligendi ea illo minus et magni itaque aut dolorem mollitia. Eos perspiciatis accusantium ut molestias ullam ut corrupti voluptatibus.</p>
        ...
        <div>
            <h2>Synthèse des données n°3</h2> 
